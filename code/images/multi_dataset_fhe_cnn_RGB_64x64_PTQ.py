...
class cnn64_rgb_ptq(nn.Module):
    """
    Post-Training Quantization (PTQ) CNN for 64x64 RGB medical images.    
    Architecture:
        - Block 1: RGB (3 channels) -> 16 features, 64x64 -> 32x32
        - Block 2: 16 -> 32 features, 32x32 -> 16x16
        - Block 3: 32 -> 48 features (double layer), 16x16 -> 4x4
        - Fully connected: 768 -> 96 -> num_classes
    """
...
def get_model_path(data_flag):
    return os.path.join(MODELS_DIR, f'model_ptq_{data_flag}.pth')
